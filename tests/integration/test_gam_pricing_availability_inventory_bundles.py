...
from tests.factories import AdapterConfigFactory, InventoryProfileFactory, TenantFactory

pytestmark = [pytest.mark.integration, pytest.mark.requires_db]


def _line_item(*, placement_id: str, impressions: int, cpm: float) -> dict:
    return {
        "placement_id": placement_id,
        "placement_name": f"Placement {placement_id}",
        "country_code": "US",
        "country": "United States",
        "line_item_id": f"li_{placement_id}",
